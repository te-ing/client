export const default_banner = '/images/add_project_default.svg';

export const default_profile = '/images/icon-profile.svg';

export const camera_icon = '/images/icon-camera.svg';

export const scrap_icon = '/images/icon-folder-add.svg';
...
export const unfollowing_icon = '/images/unfollow-icon.svg';
